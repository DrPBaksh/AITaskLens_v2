  ...
  return (
    <>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h2 className="text-xl text-corndel-blue/70">
              Analyze and classify business tasks for optimal automation strategies
            </h2>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="w-12 h-12 bg-corndel-blue/10 rounded-lg flex items-center justify-center mb-4">
            <BrainCircuit className="h-6 w-6 text-corndel-blue" />
          </div>
          <h3 className="text-lg font-semibold mb-2 text-corndel-blue">Intelligent Analysis</h3>
        ...
        >
          <div className="w-12 h-12 bg-corndel-orange/10 rounded-lg flex items-center justify-center mb-4">
            <FileText className="h-6 w-6 text-corndel-orange" />
          </div>
          <h3 className="text-lg font-semibold mb-2 text-corndel-blue">Practical Recommendations</h3>
          <p className="text-gray-600">
        ...
        >
          ...
          <h3 className="text-lg font-semibold mb-2 text-corndel-blue">Strategic Insights</h3>
          <p className="text-gray-600">
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-gray-500">
          Need inspiration? Check out our <a href="/examples" className="text-corndel-blue hover:underline">examples</a>.
        </p>
      </div>
    </>
  );
